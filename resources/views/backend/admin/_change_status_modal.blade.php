<div class="modal fade bd-example-modal-sm" id="adminStatusmodal" tabindex="-1" role="dialog" aria-labelledby="adminStatusLabel" aria-hidden="true">
        ...
        <div class="modal-content modal_icon">
            <form action="" method="post" id="admin_status_modal_clear">
                ...
                <div class="modal-title">
                    ...
                    <p id="admin_status_description"></p>
                </div>
                <br>
                <div class="text-center">
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal" style="margin:0 10px">No</button>
                    <button type="submit" class="btn btn-danger admin_status btn-sm" data-bs-dismiss="modal" style="margin:0 10px">Yes</button>
                </div>
            </form>
        </div>
    </div>
