     ...
     <div class="col-12">
         <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
             <div class="page_title_left mb_10">
                 ...
                 <p>
                     Statistics, Predictive Analytics Data Visualization, Big
                     Data Analytics, etc.
                 </p>
             </div>
                 ...
                 <div class="social_media_list">
                     <div class="single_media d-flex justify-content-between align-items-center">
                         <span class="mediaName">
                             <img src="img/currency/1.svg" alt="" /> Bitcoin</span>
                     ...
                     <div class="single_media d-flex justify-content-between align-items-center">
                         <span class="mediaName">
                             <img src="img/currency/2.svg" alt="" /> Litecoin</span>
                         <span class="earning_amount">
                             <h4>0.000242 BTC</h4>
                             <p>0.125 USD</p>
                         </span>
                     ...
                     <div class="single_media d-flex justify-content-between align-items-center">
                         <span class="mediaName">
                             <img src="img/currency/3.svg" alt="" /> Ripple</span>
                         <span class="earning_amount">
                             <h4>0.000242 BTC</h4>
                             <p>0.125 USD</p>
                         </span>
             ...
             <div class="white_card_body">
                 <div class="exchange_widget">
                     <form name="myform" class="currency_validate">
                         ...
                         <button type="submit" name="submit" class="btn_1 w-100">
                             Exchange Now
                         </button>
                     </form>
                 </div>
                             ...
                             <table class="table">
                                 <tbody>
                                     <tr>
                                         ...
                                         <td>
                                             <img class="small_img" src="img/currency/1.svg" alt="" />
                                             Bitcoin
                                         </td>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <img class="small_img" src="img/currency/2.svg" alt="" />
                                             Bitcoin
                                         </td>
                                         <td>Using - Bank......4585</td>
                                         <td>-0.000234 BTC</td>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <img class="small_img" src="img/currency/4.svg" alt="" />
                                             Bitcoin
                                         </td>
                                         <td>Using - Bank......4585</td>
                                         <td>-0.000234 BTC</td>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <img class="small_img" src="img/currency/3.svg" alt="" />
                                             Bitcoin
                                         </td>
                                         <td>Using - Bank......4585</td>
                                         <td>-0.000234 BTC</td>
                                 ...
                                 <table class="table lms_table_active2">
                                     ...
                                     <tbody>
                                         <tr>
                                             ...
                                             <td>$25.00</td>
                                             <td>
                                                 <a href="#" class="status_btn pending_btn">Pending</a>
                                             </td>
                                         </tr>
                                         <tr>
                                             <td scope="row">1</td>
                                         ...
                                         <tr>
                                             ...
                                             <td>$25.00</td>
                                             <td>
                                                 <a href="#" class="status_btn">Success</a>
                                             </td>
                                         </tr>
                                     </tbody>
                                 </table>
                     ...
                     <div class="single_news mb_20">
                         ...
                         <a href="#">
                             <p class="f_s_18 f_w_400">
                                 Aorem psum dolor sit amet, consect adipisci Quisque
                                 scelerisq.
                             </p>
                         </a>
                     </div>
