        ...
        <div class="modal-content modal_icon">
            <form action="" method="post" id="logo_status_modal_clear">
                ...
                <div class="modal-title" id="exampleModalLongTitle">
                    ...
                    <div align="middle">
                        <img src="{{ asset('backend/assets/icon/warning.png') }}" style="border-radius:unset;"
                            alt="" class="rounded-circle border border-danger p-2 img-fluid">
                    </div>
                    <br>
                        ...
                        <div class="col-3">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="location" id="location1"
                                        value="1" checked> H </label>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="location" id="location2"
                                        value="2"> M </label>
                            </div>
                        </div>
                        <div class="col-2"></div>
                ...
                <div>
                    ...
                    <button type="submit" class="btn btn-danger logo_status btn-sm" data-dismiss="modal"
