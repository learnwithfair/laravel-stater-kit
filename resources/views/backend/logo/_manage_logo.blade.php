                            ...
                            <td>
                                <form action="" method="post">
                                    ...
                                    <a class="text-danger deletebtn" style="cursor: pointer" data-id={{ $logoInfo->id }}
                                        ...
                                        <li class="fas fa-trash-alt" style="font-size:20px"></li>
                                    </a>
                                </form>
                            </td>
                        </tr>
